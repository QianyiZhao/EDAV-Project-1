...
raw_response <- as.data.frame(read.table("C:/Users/MyTablet/Dropbox/Spring 2016/EDA/Project 1/Survey+Response.csv", header=TRUE, fill = TRUE, sep=","))
...
#Write out table as text file to view in excel
write.table(agg_response, "D:/Documents/testagg.txt", sep="\t")
